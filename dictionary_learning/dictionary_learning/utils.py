...
from .trainers.temporal_sequence_top_k import TemporalMatryoshkaBatchTopKSAE
...
def load_dictionary(base_path: str, device: str, checkpoint_path=None) -> tuple:
    if checkpoint_path is None:
        ae_path = f"{base_path}/ae.pt"
    else:
        ae_path = os.path.join(base_path, checkpoint_path)
    ...
    elif dict_class == "TemporalMatryoshkaBatchTopKSAE":
        k = config["trainer"]["k"]
